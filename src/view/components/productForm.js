        ...
        <div class="product-form__body-left">
            <div class="form-section form-section--general">
                ...
                <div class="form-section__field">
                    ...
                    <input class="form-section__field--input" type="text" placeholder="Type product name here..." name="productName">
                </div>
                <div class="form-section__field"> 
                    <p class="form-section__field--name">Product Description</p>
                    <textarea class="form-section__field--textarea" placeholder="Type product description here..." name="description" id="productName"></textarea>
                </div>  
            </div>          
            ...
            <div class="form-section form-section--pricing">
                ...
                <div class="form-section__field">
                    ...
                    <input class="form-section__field--input" type="text" placeholder="$ Type base price here..." name="basePrice" id="price">
                </div>
                <div class="form-section__split">       
                        <div class="form-section__field">
                            ...
                            <select class="form-section__field--input" name="discountType">
                                <option value="no-discount">Select a discount type</option>
                        ...
                        <div class="form-section__field">
                            ...
                            <input class="form-section__field--input" type="text" placeholder="Type discount percentage..." name="discountPercentage" >
                        </div>
                </div>
                <div class="form-section__split">
                    <div class="form-section__field">
                        ...
                        <select class="form-section__field--input" name="taxClass">
                            <option value="tax-free">Select a tax class</option>
                    ...
                    <div class="form-section__field">
                        ...
                        <input class="form-section__field--input" type="text" placeholder="Type VAT amount..." name="vatAmount" >
                     </div>
                </div>     
          </div>
            ...
            <div class="form-section form-section--inventory">
                ...
                <div class="form-section__field">
                    ...
                    <input class="form-section__field--input" type="text" placeholder="Type product SKU here..." name="sku" id="sku">
                </div>
                <div class="form-section__field">
                    <p class="form-section__field--name">Barcode</p>
                    <input class="form-section__field--input" type="text" placeholder="Product barcode..." name="barcode">
                </div>
                <div class="form-section__field">
                    <p class="form-section__field--name">Quantity</p>
                    <input class="form-section__field--input" type="text" placeholder="Type product quantity here..." name="quantity">
                </div>
            </div>
        </div>
            ...
            <div class="form-section">
                ...
                <div class="dropdown" id="dropdowntop">
                        <div class="dropdown-group">
                            <div class="dropbtn" id="dropdownButtonTop">None</div>
            ...
            <div class="form-section"> 
                <div class="form-section__title">
                    ...
                    <div class="form-section__title-status--label ">                       
                        <p class="form-section__title-status--label-text draft" id="status-text" >draft </p>                         
                    </div>  
                </div> 
                <div class="form-section__field">
                    <p class="form-section__field--name">Product Category</p>             
                </div> 
                <div class="dropdown" id="dropdown">
                        <div class="dropdown-group">
                            <div class="dropbtn" id="dropdownButton">Draft</div>
                            <img src="${caretDown}" alt="caret-down" class="caret-down"/>
                        </div>
                        <div class="dropdown-content" id="dropdownContent">
                            <div data-value="Draft">Draft</div>
                            <div data-value="Publish">Publish</div>
                            <div data-value="Out of Stock">Out of Stock</div>
                            <div data-value="Stock">Low Stock</div>
                        </div>
                </div>
            </div> 
        </div> 
